...
public class Homepage extends AppCompatActivity {
    ...
    Button announcementBtn, clubBtn, msgBtn, merchandiseBtn, logoutBtn;
    ...
    public void init() {
        ...
        msgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(Homepage.this, Message.class);
                startActivity(in);
            }
        });
...
// ADAPTER IS A CONTAINER THAT WILL HOLD VALUES AND INTEGRATE THEM WITH THE SPINNER
        ...
        mySpinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 1) {
                    startActivity(new Intent(Homepage.this, Buy.class));

                } else if (i == 2) {
                    startActivity(new Intent(Homepage.this, Sell.class));
                } else if (i == 3) {
                    startActivity(new Intent(Homepage.this, Lend.class));
                } else if (i == 4) {
                    startActivity(new Intent(Homepage.this, Exchange.class));
                }
